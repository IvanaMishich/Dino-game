    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('min_score', models.IntegerField(null=True, verbose_name='Минимальные очки')),
                ('max_score', models.IntegerField(null=True, verbose_name='Максимальные очки')),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
            fields=[
                ...
                ('level', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='players_levels', to='Dino.levels', verbose_name='Уровень')),
            ],
            options={
                'verbose_name': 'user',
